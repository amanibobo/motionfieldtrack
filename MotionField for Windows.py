...
def help_window():
    ...
    help_why = \
"""The name MotionField comes from my desire of Track & Field - Ive been very interested in high-jump \
ideal about the chaotic movement of real-life objects.

Let's start with a review of the Goals of the MotionField project (the App):
